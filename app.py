...
from model import open_data, preprocess_data, recode_value, fit_and_save_model
...
def show_main_page():
    ...
    st.write(
        ...
        Определяем, кто из клиентов примет предложение.
        """
    )
...
def process_side_bar_inputs():
    ...
    df = open_data()
    X_train, X_test, y_train, y_test = preprocess_data(df, test=True)
